...
import { FilaJornadaFormularioProps } from '../../types/tablaJornadas/filaJornadasFormularioProps';

export const FilaJornadaFormulario = ({ 
    fecha, 
    dia, 
    control, 
    creando, 
    ...
    <>
        ...
        <TableCell colSpan={7} align='center' size='small'>
            <div className='text-gray-700 font-medium' style={{ userSelect: 'none' }}>
                <Controller
                    name='observacion'
                    control={control}
