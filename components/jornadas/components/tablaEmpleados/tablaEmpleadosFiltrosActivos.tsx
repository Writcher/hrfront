...
import { TablaEmpleadosFiltrosActivosProps } from '../../types/tablaEmpleados/tablaEmpleadosFiltrosActivosProps';

export const TablaEmpleadosFiltrosActivos = ({
  filtrosActivos,
  getNombreProyectoPorId,
  getNombreTipoEmpleadoPorId,
  handleLimpiarFiltro
}: TablaEmpleadosFiltrosActivosProps) => (
