...
import { TablaResumenFiltrosFormularioProps } from '../../types/tablaResumen/tablaResumenFiltrosFormularioProps';

export const TablaResumenFiltrosFormulario = ({
    filtroMes,
    filtroQuincena,
    selectCargando,
    selectDatos,
...
}: TablaResumenFiltrosFormularioProps) => (
