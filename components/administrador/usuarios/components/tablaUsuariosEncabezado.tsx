...
export const Encabezado = ({ onOrden, columna, direccion }: encabezadoProps) => (
    ...
    >
        <TableRow>
            <TableCell align="left" onClick={() => onOrden('nombre')} style={{ cursor: 'pointer' }} width="25%">
            ...
            <TableCell align="center" onClick={() => onOrden('correo')} style={{ cursor: 'pointer' }} width="30%">
                <div style={{ userSelect: "none" }}
            ...
            <TableCell align="center" onClick={() => onOrden('id_tipousuario')} style={{ cursor: 'pointer' }} width="25%">
                <div style={{ userSelect: "none" }}
