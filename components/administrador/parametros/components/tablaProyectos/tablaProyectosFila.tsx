...
import { deleteProyectoParametros, editProyectoParametros, filaProyectoProps, modalidadTrabajo, proyectoFilaFormularioDatos } from "../../types";
import { useSnackbar } from "@/lib/context/snackbarcontext";
import { useMutation, useQuery, useQueryClient } from "@tanstack/react-query";
import { deleteProyecto, editProyecto } from "@/services/proyecto/service.proyecto";
import { useProyectoFilaFormulario } from "../../hooks/useProyectoFilaFormulario";
...
export default function FilaProyecto({ proyecto }: filaProyectoProps) {
    ...
    const { control, formState: { isValid }, setValue, handleSubmit, reset } = useProyectoFilaFormulario()
    ...
    const onEdit = (data: proyectoFilaFormularioDatos) => {
        mutacionEdit.mutate({
