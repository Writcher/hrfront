...
interface CrearJornadaFormularioProps {
    formularioDatos: any;
    formularioCargando: boolean;
    control: any;
    watch: any;
    switchFormulario: any;
}

export const CrearJornadaFormulario: React.FC<CrearJornadaFormularioProps> = ({
    formularioDatos,
    formularioCargando,
    control,
    watch,
    ...
    <form className="flex flex-col justify-start items-center gap-4 h-auto w-full">
        ...
        <div className="flex flex-row justify-start items-center gap-2 w-full">
            ...
            {watch("tipoJornada") === formularioDatos?.id_ausenciaJustificada ?
                formularioCargando ?
                    <Skeleton
                        variant="rectangular"
                        width="100%"
        ...
        <div className="flex flex-row justify-start items-start gap-2 w-full">
            ...
            <div className="flex flex-col justify-start items-center gap-2 w-[67%]">
                {watch("tipoJornada") !== formularioDatos?.id_ausenciaJustificada && watch("tipoJornada") !== formularioDatos?.id_ausenciaInjustificada ? (
                    <div className="flex flex-row justify-start items-center gap-2 w-full">
                        <Controller
                            name="entrada"
                            control={control}
