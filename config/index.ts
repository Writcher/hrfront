...
export default {
    ...
    URL_CREAR_TIPOAUSENCIA: process.env.URL_CREAR_TIPOAUSENCIA,
    ...
    URL_TURNOS: process.env.URL_TURNOS,
    URL_CREAR_PROYECTO: process.env.URL_CREAR_PROYECTO,
    URL_PROYECTO: process.env.URL_PROYECTO,
    URL_MODALIDADESTRABAJO: process.env.URL_MODALIDADESTRABAJO,
    URL_CREAR_CONTROL: process.env.URL_CREAR_CONTROL,
    URL_CONTROL: process.env.URL_CONTROL,
    URL_CONTROLES: process.env.URL_CONTROLES,
};